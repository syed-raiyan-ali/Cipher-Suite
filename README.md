...
- **Firebase:** Firebase: Integrated for **Authentication**, **Cloud Firestore database** to store and retrieve user cipher history across devices, and **Hosting** the production deployment.
